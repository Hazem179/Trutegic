...
!function (t) {
    ...
    var a, u = function () {
        ...
        s = "undefined" == typeof setImmediate ? setTimeout : setImmediate, d = [];
    ...
    function E(t, n) {
        var o = n.fetch, r = n.XMLHttpRequest, i = n.token;
    ...
    function _(t, e) {
        ...
        }, r = e.document || r, a = c.bind(c, r, ["fa", "fab", "fas", "far", "fal", "fad", "fak"]);
        t.autoA11y.enabled && n(a);
        var u = [{id: "fa-tools", addOn: void 0}];
        t.v4shim.enabled && u.push({
            id: "fa-v4-shims",
            addOn: "-v4-shims"
        }), t.v4FontFaceShim.enabled && u.push({id: "fa-v4-font-face", addOn: "-v4-font-face"});
        var f = u.map((function (n) {
            return new S((function (r, c) {
                E(i(t, {addOn: n.addOn, minify: t.minify.enabled}), e).then((function (i) {
                    r(P(i, o({}, e, {baseUrl: t.baseUrl, version: t.version, id: n.id})))
                })).catch(c)
            }))
        }));
        return S.all(f)
    ...
    function P(t, e) {
        var n = document.createElement("style"), o = document.createTextNode(function (t, e, n) {
            var o = t;
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            var k = window.FontAwesomeKitConfig, x = {
                ...
                document: document
            }, I = document.currentScript, U = I ? I.parentElement : document.head;
            (function () {
